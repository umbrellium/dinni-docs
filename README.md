# Dinni OpenAPI Specification
[![Build Status](https://travis-ci.org/umbrellium/dinni-docs.svg?branch=master)](https://travis-ci.org/umbrellium/dinni-docs)
...
6. If you did everything correct, https://umbrellium.github.io/dinni-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://umbrellium.github.io/dinni-docs/
- SwaggerUI: https://umbrellium.github.io/dinni-docs/swagger-ui/
- Look full spec:
    + JSON https://umbrellium.github.io/dinni-docs/swagger.json
    + YAML https://umbrellium.github.io/dinni-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://umbrellium.github.io/dinni-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://umbrellium.github.io/dinni-docs/ with url from the message: `Server started <url>`
